              ...
              <div className="inner">
                <div className="site-header-inside">
                  <div className="site-branding">
                    ...
                    <h1 className="site-title"><Link href={withPrefix('/')}>{_.get(this.props, 'data.config.title', null)}</Link></h1>
                    ) : 
                    <p className="site-title"><Link href={withPrefix('/')}>{_.get(this.props, 'data.config.title', null)}</Link></p>
                    }
                  </div>
